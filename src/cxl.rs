...
use cudarc::driver::cudaHostRegister;
...
impl CxlPool {
    pub fn new(pool_path: &str, size_bytes: usize, multi_host_pool_id: &str) -> Result<Self, std::io::Error> {
        ...
        Ok(CxlPool {
            ...
            base,
            size: size_bytes,
            multi_host_pool_id: multi_host_pool_id.to_string(),
        })
    }
...
unsafe impl Send for CxlPool {}
unsafe impl Sync for CxlPool {}
